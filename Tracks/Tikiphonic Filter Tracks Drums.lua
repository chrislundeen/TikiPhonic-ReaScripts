--[[
  * ReaScript Name: 'TikiPhonic: Filter Tracks -> [Drums]'
  * Description: Filter Tracks - Drums ([Drums] tag on Track Manager filter field)
...
-- Set Helper Script --------------------------------------------
local script = "helpers/Tikiphonic Helper Filter Tracks Manager.lua"
