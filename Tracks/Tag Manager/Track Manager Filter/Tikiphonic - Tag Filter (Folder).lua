--[[
  * ReaScript Name: 'TikiPhonic: Tag Filter (Folder)'
  * Description: Tag Filter Tracks - Instrument ([folder] tag on Track Manager filter field)
