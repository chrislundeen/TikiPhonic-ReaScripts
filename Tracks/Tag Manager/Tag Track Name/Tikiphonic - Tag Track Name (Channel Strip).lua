--[[
  * ReaScript Name: 'TikiPhonic: Tag Track Name (Channel Strip)'
  * Description: - Tag Track Name - (Manage tags on Tracks) - Channel Strip
...
InitTrackTagName('[channelstrip]', false)
