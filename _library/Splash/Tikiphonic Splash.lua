...
function InitSplash()
  ...
  local msg_str = "Thanks for using TikiPhonic ReaScripts!"
  ...
  local function Splash()
    ...
    gfx.loadimg(buffer_id, reaper.GetResourcePath() .. '/Data/track_icons/Custom/tikiphonic_tiki.png')
    gfx.drawstr(msg_str)
